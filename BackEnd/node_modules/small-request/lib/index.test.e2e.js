...
_test('Connection error rejects promise', assert =>{
  ...
  const url = 'https://3.86.151.156:9999';
...
_test('Basic GET fails to receive response within socketTimeout should abort', assert => {
...
_test('Basic GET receives response within socketTimeout should succeed', assert => {
