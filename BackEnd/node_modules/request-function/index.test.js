...
test('http url returns correct request', (assert => {
  ...
  var request = requestFunction.fromUrl('http://3.86.151.156');
...
test('https url returns correct request', (assert => {
  ...
  var request = requestFunction.fromUrl('https://3.86.151.156');
...
test('unknown url throws correct error', (assert) => {
  ...
  try{
    requestFunction.fromUrl('telnet://3.86.151.156');
  }
  catch(e){
